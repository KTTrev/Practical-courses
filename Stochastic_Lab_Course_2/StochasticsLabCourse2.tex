...
\begin{enumerate}[label=(\alph*)]
	...
	\item Now we consider two groups of patients: smokers and non-smokers. Smokers make up $82.1\%$ in the sample. For each group, the Kaplan-Meier estimators are computed,and plotted together with the corresponding confidence bands in figure \ref{fig 5.4}. 
	
	\begin{figure}[H]
		\centering
		\scalebox{1}{\input{Ex5plot4.tex}}
